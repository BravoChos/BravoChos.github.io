        ...
        <div>
            ...
            <div className="resume__wrapper">
                ...
                <p className="resume-intro">
                    Self-driven, passionate about learning new skills and believe that leveraging technology is best way to create social
                    impact. In my free time, I often enjoy playing drums and travel around to experience new culture.
                    <br />
                </p>
              ...
              <div className="resume__workplace__body">
                ...
                <div className="resume-card">
                    ...
                    <div className="resume-workExperience">
                        <div className="subcard">
                            ...
                            <div className="resume__workplace__body">
                                Currently developing virtual guide service which allows bulter to support traveler virtualy through chat.
                                Thanks to our gps feature, VUTLER can track traveler's location and other features such as sending photos,
                                sharing map, and push notifications allow both VUTLER and traveler wonderful user experience.
                            </div>
                            <div className="resume__workplace__subtitle">
                                What did I do<span className="period__mark">.</span>
                            </div>
                        ...
                        <div className="subcard">
                            ...
                            <div className="resume__workplace__body">
                                Add new feature called spot service to our app. It provides list of guides who are active and highly
                                available to traveler based on user's current location or destination. Authentication process has been
                                upgraded with more features such as reset password, phone and email verification etc.
                            </div>
                            <div className="resume__workplace__subtitle">
                                What did I do<span className="period__mark">.</span>
                            </div>
                        ...
                        <div className="subcard">
                            ...
                            <div className="resume__workplace__body">
                                Build global travel platforms (ios, android) that connect travelers and friendly locals(Guides) who are
                                ready to offer special travel experiences according to client needs.
                            </div>
                            <div className="resume__workplace__subtitle">
                                What did I do<span className="period__mark">.</span>
                            </div>
                        ...
                        <div className="subcard">
                            ...
                            <div className="resume__workplace__body">
                                Established ideation of our app and UI after understanding the needs in travel industy, and then degined the
                                system architecture with specific features that our app requires.
                            </div>
                            <div className="resume__workplace__subtitle">
                                What did I do<span className="period__mark">.</span>
                            </div>
                            <div className="resume__workplace__body">
                                ...
                                <br />- Analyze the current most poplar travel application, conducted market research, and establishing
                                objectives within a timeline
                ...
                <div className="resume-card">
                    ...
                    <div className="resume-workExperience">
                        <div className="subcard">
                            ...
                            <div className="resume__workplace__body">
                                monitors various equipment sensors and display the current status in table form. It can control/update the
                                sensor's setting value, and To-do-list alert feature
                            </div>
                            <div className="resume__workplace__subtitle">
                                What did I do<span className="period__mark">.</span>
                            </div>
                ...
                <div className="resume-card">
                    ...
                    <div className="resume-workExperience">
                        ...
                        <div className="resume__workplace__body">
                            ⬥ Conducted mass production process of horticultural granules, and carried out studies on cost reduction and
