  ...
  return (
    <div>
      ...
      <div className="resume__wrapper">
        ...
        <SectionTitleDeleteme title={"Work Experience"} />
        ...
        <div className="resume-card">
          ...
          <div className="resume-workExperience">
            ...
            <div className="subcard">
              ...
              <div className="resume__workplace__body">
                Build global travel platforms (ios, android) that connect travelers and friendly locals(Guides) who are ready to offer
